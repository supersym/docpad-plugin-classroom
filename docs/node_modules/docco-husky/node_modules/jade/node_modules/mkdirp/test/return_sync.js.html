...
<span class="nx">test</span><span class="p">(</span><span class="s1">&#39;return value&#39;</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">t</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="kd">var</span> <span class="nx">file</span> <span class="o">=</span> <span class="s1">&#39;/tmp/&#39;</span> <span class="o">+</span> <span class="p">[</span><span class="nx">x</span><span class="p">,</span><span class="nx">y</span><span class="p">,</span><span class="nx">z</span><span class="p">].</span><span class="nx">join</span><span class="p">(</span><span class="s1">&#39;/&#39;</span><span class="p">);</span></pre></div></td></tr><tr id="section-2"><td class="docs"><div class="pilwrap"><a href="#section-2" class="pilcrow">&#182;</a></div><p>should return the first dir created.
By this point, it would be profoundly surprising if /tmp didn't
already exist, since every other test makes things in there.
Note that this will throw on failure, which will fail the test.</p>
</td><td class="code"><div class="highlight"><pre>    <span class="kd">var</span> <span class="nx">made</span> <span class="o">=</span> <span class="nx">mkdirp</span><span class="p">.</span><span class="nx">sync</span><span class="p">(</span><span class="nx">file</span><span class="p">);</span>
    <span class="nx">t</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">made</span><span class="p">,</span> <span class="s1">&#39;/tmp/&#39;</span> <span class="o">+</span> <span class="nx">x</span><span class="p">);</span></pre></div></td></tr><tr id="section-3"><td class="docs"><div class="pilwrap"><a href="#section-3" class="pilcrow">&#182;</a></div><p>making the same file again should have no effect.</p>
</td><td class="code"><div class="highlight"><pre>    <span class="nx">made</span> <span class="o">=</span> <span class="nx">mkdirp</span><span class="p">.</span><span class="nx">sync</span><span class="p">(</span><span class="nx">file</span><span class="p">);</span>
...
</pre></div></td></tr></tbody></table><div id="generated">generated Fri Jan 04 2013 21:20:45 GMT+0100 (CET)  </div></div></body></html>